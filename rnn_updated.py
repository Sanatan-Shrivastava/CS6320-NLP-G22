...
if __name__ == "__main__":
    ...
    while not stopping_condition:
        ...
        if total > 0:
            print("Test accuracy for epoch {}: {}".format(epoch + 1, test_accuracy))
            print("Test accuracy for epoch {}: {}".format(epoch + 1, correct / total))
            test_accuracy = correct / total
        else:
            print("No test examples in the dataset.")
        # print("Test completed for epoch {}".format(epoch + 1))
        # print("Test accuracy for epoch {}: {}".format(epoch + 1, correct / total))
        # test_accuracy = correct/total

        if test_accuracy < last_test_accuracy and trainning_accuracy > last_train_accuracy:
            stopping_condition=True
            print("Training done to avoid overfitting!")
